...
export default {
  ...
  // Watch the data and do something when it changes, like a component did update
  watch: {
    number(newValue) {
      // give it access to all data in this component
      gsap.to(this.$data, {
        duration: 1,
        ease: 'circ.out',
        // tween number will smooth out the randomness
